...
// triangulation.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CtriangulationApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CtriangulationApp
...
// Единственный объект CtriangulationApp

CtriangulationApp theApp;


// Инициализация CtriangulationApp
